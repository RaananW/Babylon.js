import { type Observer, type Nullable, type Scene, type SubMesh, type AbstractMesh, type Mesh, type Effect, type IThinEffectLayerOptions, type Color3, type EffectWrapper } from "core/index"
