...
export function VideoTextureCreateFromStreamAsync(scene: Scene, stream: MediaStream, constraints: any, invertY = true): Promise<VideoTexture> {
...
export async function VideoTextureCreateFromWebCamAsync() {
    ...
    if (navigator.mediaDevices) {
        ...
        const videoTexture = await VideoTextureCreateFromStreamAsync(scene, stream, constraints, invertY);
        videoTexture.onDisposeObservable.addOnce(() => {
