 ...
 */
export function NodeParticleSystemSetCreateDefault(name: string) {
...
export function NodeParticleSystemSetParseFromFileAsync(name: string, url: string, nodeParticleSet?: NodeParticleSystemSet): Promise<NodeParticleSystemSet> {
 ...
 */
// eslint-disable-next-line @typescript-eslint/promise-function-async, no-restricted-syntax
export function NodeParticleSystemSetParseFromSnippetAsync(snippetId: string, nodeParticleSet?: NodeParticleSystemSet): Promise<NodeParticleSystemSet> {
    if (snippetId === "_BLANK") {
        return Promise.resolve(NodeParticleSystemSetCreateDefault("blank"));
    }
