...
import { Vector3, Matrix } from "./math.vector.pure";
 ...
 */
export function PlaneFromArray(array: DeepImmutable<ArrayLike<number>>): Plane {
 ...
 */
export function PlaneFromPoints(point1: DeepImmutable<Vector3>, point2: DeepImmutable<Vector3>, point3: DeepImmutable<Vector3>): Plane {
 ...
 */
export function PlaneFromPositionAndNormal(origin: DeepImmutable<Vector3>, normal: Vector3): Plane {
    const plane = new Plane(0.0, 0.0, 0.0, 0.0);
    return PlaneFromPositionAndNormalToRef(origin, normal, plane);
}
 ...
 */
export function PlaneFromPositionAndNormalToRef<T extends Plane>(origin: DeepImmutable<Vector3>, normal: DeepImmutable<Vector3>, result: T): T {
