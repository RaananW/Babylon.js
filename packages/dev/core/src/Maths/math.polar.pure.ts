 ...
 * @returns the updated reference
 */
export function PolarFromVector2ToRef(v: Vector2, ref: Polar): Polar {
 ...
 * @returns a Polar
 */
export function PolarFromVector2(v: Vector2): Polar {
    const polar = new Polar(0, 0);
    PolarFromVector2ToRef(v, polar);
    return polar;
}
 ...
 */
export function PolarFromArray(array: number[]) {
 ...
 * @returns the updated ref
 */
export function SphericalFromVector3ToRef(vector: DeepImmutable<Vector3>, ref: Spherical): Spherical {
 ...
 */
export function SphericalFromVector3(vector: DeepImmutable<Vector3>): Spherical {
    const spherical = new Spherical(0, 0, 0);
    SphericalFromVector3ToRef(vector, spherical);
    return spherical;
}
