 ...
 */
export function BezierCurveInterpolate(t: number, x1: number, y1: number, x2: number, y2: number): number {
    if (t === 0) {
        return 0;
    }
 ...
 * @returns a new Angle
 */
export function AngleBetweenTwoPoints(a: DeepImmutable<Vector2>, b: DeepImmutable<Vector2>): Angle {
 ...
 */
export function AngleBetweenTwoVectors<Vec extends Vector2 | Vector3 | Vector4>(a: DeepImmutable<Vec>, b: DeepImmutable<Vec>): Angle {
...
export class Arc2 {
    ...
    constructor(
        ...
        this.startAngle = AngleBetweenTwoPoints(this.centerPoint, this.startPoint);

        const a1 = this.startAngle.degrees();
        let a2 = AngleBetweenTwoPoints(this.centerPoint, this.midPoint).degrees();
        let a3 = AngleBetweenTwoPoints(this.centerPoint, this.endPoint).degrees();
        ...
        this.angle = AngleFromDegrees(this.orientation === Orientation.CW ? a1 - a3 : a3 - a1);
    }
}
 ...
 */
export function Path2StartingAt(x: number, y: number): Path2 {
 ...
 */
export function Curve3CreateQuadraticBezier(v0: DeepImmutable<Vector3>, v1: DeepImmutable<Vector3>, v2: DeepImmutable<Vector3>, nbPoints: number): Curve3 {
 ...
 * @returns the created Curve3
 */
export function Curve3CreateCubicBezier(v0: DeepImmutable<Vector3>, v1: DeepImmutable<Vector3>, v2: DeepImmutable<Vector3>, v3: DeepImmutable<Vector3>, nbPoints: number): Curve3 {
 ...
 * @returns the created Curve3
 */
export function Curve3CreateHermiteSpline(p1: DeepImmutable<Vector3>, t1: DeepImmutable<Vector3>, p2: DeepImmutable<Vector3>, t2: DeepImmutable<Vector3>, nSeg: number): Curve3 {
 ...
 * @returns the created Curve3
 */
export function Curve3CreateCatmullRomSpline(points: DeepImmutable<Vector3[]>, nbPoints: number, closed?: boolean): Curve3 {
 ...
 * @returns the created Curve3
 */
export function Curve3ArcThru3Points(first: Vector3, second: Vector3, third: Vector3, steps: number = 32, closed: boolean = false, fullCircle: boolean = false): Curve3 {
    const arc: Vector3[] = [];
