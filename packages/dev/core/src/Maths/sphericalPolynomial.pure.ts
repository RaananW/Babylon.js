...
export class SphericalPolynomial {
    ...
    public get preScaledHarmonics(): SphericalHarmonics {
        if (!this._harmonics) {
            this._harmonics = SphericalHarmonicsFromPolynomial(this);
        }
 ...
 */
export function SphericalHarmonicsFromArray(data: ArrayLike<ArrayLike<number>>): SphericalHarmonics {
 ...
 * @returns the spherical harmonics
 */
export function SphericalHarmonicsFromPolynomial(polynomial: SphericalPolynomial): SphericalHarmonics {
 ...
 * @returns the spherical polynomial
 */
export function SphericalPolynomialFromHarmonics(harmonics: SphericalHarmonics): SphericalPolynomial {
 ...
 * @returns the spherical polynomial
 */
export function SphericalPolynomialFromArray(data: ArrayLike<ArrayLike<number>>): SphericalPolynomial {
