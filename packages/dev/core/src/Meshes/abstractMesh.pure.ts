...
import type { IEdgesRenderer, IEdgesRendererOptions } from "../Rendering/edgesRenderer";
...
AbstractMesh.prototype.applyImpulse ??= _MissingSideEffect("AbstractMesh", "applyImpulse") as any;
