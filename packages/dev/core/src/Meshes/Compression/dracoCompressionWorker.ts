...
import { type DecoderBuffer, type Decoder, type Mesh, type PointCloud, type Status, type DecoderModule, type EncoderModule, type MeshBuilder, type Encoder, type DracoInt8Array } from "draco3dgltf"
