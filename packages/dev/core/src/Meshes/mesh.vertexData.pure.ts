...
export class VertexData implements IVertexDataLike {
    ...
    public clone() {
        ...
        return VertexDataParse(serializationObject);
    }
 ...
 */
export function VertexDataCreateRibbon(options: {
    pathArray: Vector3[][];
    closeArray?: boolean;
    closePath?: boolean;
    offset?: number;
 ...
 */
export function VertexDataCreateBox(options: {
    size?: number;
    width?: number;
    height?: number;
    depth?: number;
 ...
 */
export function VertexDataCreateTiledBox(options: {
    pattern?: number;
    width?: number;
    height?: number;
    depth?: number;
 ...
 */
export function VertexDataCreateTiledPlane(options: {
    pattern?: number;
    tileSize?: number;
    tileWidth?: number;
    tileHeight?: number;
 ...
 */
export function VertexDataCreateSphere(options: {
    segments?: number;
    diameter?: number;
    diameterX?: number;
    diameterY?: number;
 ...
 */
export function VertexDataCreateCylinder(options: {
    height?: number;
    diameterTop?: number;
 ...
 */
export function VertexDataCreateTorus(options: {
    diameter?: number;
    thickness?: number;
    tessellation?: number;
    sideOrientation?: number;
 ...
 */
export function VertexDataCreateLineSystem(options: { lines: Vector3[][]; colors?: Nullable<Color4[][]> }): VertexData {
 ...
 */
export function VertexDataCreateDashedLines(options: { points: Vector3[]; dashSize?: number; gapSize?: number; dashNb?: number }): VertexData {
    throw _WarnImport("linesBuilder");
}
 ...
 */
export function VertexDataCreateGround(options: { width?: number; height?: number; subdivisions?: number; subdivisionsX?: number; subdivisionsY?: number }): VertexData {
 ...
 */
export function VertexDataCreateTiledGround(options: {
    xmin: number;
    zmin: number;
    xmax: number;
    zmax: number;
 ...
 */
export function VertexDataCreateGroundFromHeightMap(options: {
    width: number;
    height: number;
    subdivisions: number;
    minHeight: number;
 ...
 */
export function VertexDataCreatePlane(options: { size?: number; width?: number; height?: number; sideOrientation?: number; frontUVs?: Vector4; backUVs?: Vector4 }): VertexData {
 ...
 */
export function VertexDataCreateIcoSphere(options: {
    radius?: number;
    radiusX?: number;
    radiusY?: number;
    radiusZ?: number;
 ...
 */
export function VertexDataCreatePolyhedron(options: {
    type?: number;
    size?: number;
    sizeX?: number;
    sizeY?: number;
 ...
 */
export function VertexDataCreateCapsule(
 ...
 */
export function VertexDataCreateTorusKnot(options: {
    radius?: number;
    tube?: number;
 ...
 */
export function VertexDataComputeNormals(
    positions: any,
    indices: any,
    normals: any,
    options?: {
 ...
 * @internal
 */
export function VertexData_ComputeSides(
    sideOrientation: number,
 ...
 */
export function VertexDataParse(parsedVertexData: any) {
    const vertexData = new VertexData();
 ...
 */
export function VertexDataImportVertexData(parsedVertexData: any, geometry: Geometry) {
