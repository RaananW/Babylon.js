 ...
 * @returns a SceneOptimizerOptions object
 */
export function SceneOptimizerOptionsLowDegradationAllowed(targetFrameRate?: number): SceneOptimizerOptions {
 ...
 * @returns a SceneOptimizerOptions object
 */
export function SceneOptimizerOptionsModerateDegradationAllowed(targetFrameRate?: number): SceneOptimizerOptions {
    const result = new SceneOptimizerOptions(targetFrameRate);
 ...
 * @returns a SceneOptimizerOptions object
 */
export function SceneOptimizerOptionsHighDegradationAllowed(targetFrameRate?: number): SceneOptimizerOptions {
    const result = new SceneOptimizerOptions(targetFrameRate);
 ...
 * @returns the new SceneOptimizer object
 */
// This function is not technically Async
// eslint-disable-next-line no-restricted-syntax
export function SceneOptimizerOptimizeAsync(scene: Scene, options?: SceneOptimizerOptions, onSuccess?: () => void, onFailure?: () => void): SceneOptimizer {
    const optimizer = new SceneOptimizer(scene, options || SceneOptimizerOptionsModerateDegradationAllowed(), false);
