 ...
 */
export function ToolsIsAbsoluteUrl(url: string): boolean {
 ...
 */
export function ToolsFetchToRef(u: number, v: number, width: number, height: number, pixels: Uint8Array, color: IColor4Like): void {
 ...
 */
export function ToolsInstantiate(className: string): any {
 ...
 * @returns number
 */
export function ToolsFloatRound(value: number): number {
 ...
 */
export function ToolsGetFilename(path: string): string {
 ...
 */
export function ToolsGetFolderPath(uri: string, returnUnchangedIfNoSlash = false): string {
 ...
 */
export function ToolsToDegrees(angle: number): number {
 ...
 */
export function ToolsToRadians(angle: number): number {
 ...
 * @returns the angle in degrees
 */
export function ToolsSmoothAngleChange(previousAngle: number, newAngle: number, smoothFactor = 0.9): number {
    const previousAngleRad = ToolsToRadians(previousAngle);
    const newAngleRad = ToolsToRadians(newAngle);
    return ToolsToDegrees(
        Math.atan2(
 ...
 */
export function ToolsMakeArray(obj: any, allowsNullUndefined?: boolean): Nullable<Array<any>> {
 ...
 */
export function ToolsGetPointerPrefix(engine: AbstractEngine): string {
 ...
 */
export function ToolsSetCorsBehavior(url: string | string[], element: { crossOrigin: string | null }): void {
 ...
 */
export function ToolsSetReferrerPolicyBehavior(referrerPolicy: Nullable<ReferrerPolicy>, element: { referrerPolicy: string | null }): void {
 ...
 */
export function ToolsLoadImage(
...
export async function ToolsLoadFileAsync(url: string, useArrayBuffer?: true): Promise<ArrayBuffer>;
export async function ToolsLoadFileAsync(url: string, useArrayBuffer?: false): Promise<string>;
 ...
 */
export async function ToolsLoadFileAsync(url: string, useArrayBuffer = true): Promise<ArrayBuffer | string> {
    return await new Promise((resolve, reject) => {
        FileToolsLoadFile(
            url,
            (data) => {
 ...
 * @returns a file request object
 */
export function ToolsReadFileAsDataURL(fileToLoad: Blob, callback: (data: any) => void, progressCallback: (ev: ProgressEvent) => any): IFileRequest {
    const reader = new FileReader();
 ...
 */
export function ToolsFileAsURL(content: string): string {
 ...
 */
export function ToolsFormat(value: number, decimals = 2): string {
 ...
 */
export function ToolsIsEmpty(obj: any): boolean {
    for (const i in obj) {
 ...
 */
export function ToolsRegisterTopRootEvents(windowElement: Window, events: { name: string; handler: Nullable<(e: FocusEvent) => any> }[]): void {
 ...
 */
export function ToolsUnregisterTopRootEvents(windowElement: Window, events: { name: string; handler: Nullable<(e: FocusEvent) => any> }[]): void {
    for (let index = 0; index < events.length; index++) {
        const event = events[index];
 ...
 */
export function ToolsDownload(blob: Blob, fileName: string): void {
 ...
 */
export function ToolsBackCompatCameraNoPreventDefault(args: IArguments): boolean {
 ...
 */
export function ToolsRandomId(): string {
    return RandomGUID();
}
 ...
 */
export function ToolsIsBase64(uri: string): boolean {
 ...
 */
export function ToolsDecodeBase64(uri: string): ArrayBuffer {
 ...
 */
export function ToolsLog(message: string): void {
    Logger.Log(message);
}
 ...
 * @param message defines the message to log
 */
export function ToolsWarn(message: string): void {
    Logger.Warn(message);
}
 ...
 * @param message defines the message to log
 */
export function ToolsError(message: string): void {
 ...
 */
export function ToolsClearLogCache(): void {
 ...
 */
export function ToolsGetClassName(object: any, isType = false): string {
    let name = null;
 ...
 */
export function ToolsFirst<T>(array: Array<T>, predicate: (item: T) => boolean): Nullable<T> {
 ...
 */
export async function ToolsDelayAsync(delay: number): Promise<void> {
 ...
 */
export function ToolsIsSafari(): boolean {
