 ...
 */
export function ActionEventCreateNew(source: AbstractMesh, evt?: any, additionalData?: any): ActionEvent {
 ...
 * @returns the new ActionEvent
 */
export function ActionEventCreateNewFromSprite(source: Sprite, scene: Scene, evt?: any, additionalData?: any): ActionEvent {
 ...
 * @returns the new ActionEvent
 */
export function ActionEventCreateNewFromScene(scene: Scene, evt: any): ActionEvent {
