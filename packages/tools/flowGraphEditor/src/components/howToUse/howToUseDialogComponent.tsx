...
const CodeBlock: FunctionComponent<{ code: string }> = (props) => {
    const { code } = props;
 ...
 */
export const HowToUseDialogComponent: FunctionComponent<IHowToUseDialogProps> = (props) => {
    const { globalState, onClose } = props;
    const classes = useStyles();
                    ...
                    <DialogContent className={classes.body}>
                        ...
                        <div className={classes.section}>
                            ...
                            <Text>
                                ...
                                <Text className={classes.inlineCode}>coordinator.start()</Text> after parsing to begin execution. The scene&apos;s objects (meshes, lights, cameras)
